  ...
  Widget build(BuildContext context) {
    return TextField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: const EdgeInsets.only(top: 18, bottom: 8, left: 10),
          isDense: true,
          ...
          suffixIcon: !widget.isPassword
              ? widget.suffix == null
                  ? widget.controller.text.isNotEmpty && widget.showIcon == true
                      ? GestureDetector(
                          onTap: () {
                            setState(() {
          ...
          errorStyle: const TextStyle(fontSize: 10, color: red),
        ),
