...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserAccount user, String accessToken)
        authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserAccount user, String accessToken)? authenticated,
...
abstract class AuthStateAuthenticated implements AuthState {
  const factory AuthStateAuthenticated(
      ...
      required final String accessToken}) = _$AuthStateAuthenticatedImpl;
