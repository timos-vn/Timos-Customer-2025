...
class CustomQuestionComponent extends StatefulWidget {
  ...
  const CustomQuestionComponent({Key? key,this.iconData, this.title, this.content, this.showTwoButton, this.buttonConfirmTitle}) : super(key: key);
  @override
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(widget.title.toString(),style:  TextStyle(fontWeight: FontWeight.w600,fontSize: 18,color: Colors.black),),
                        const SizedBox(height: 10,),
  ...
  Widget _submitButton(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            onTap: ()=>Navigator.pop(context,'Yeahh'),
            child: Container(
              width: 130,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  gradient: const LinearGradient(
                      ...
                      colors: [Color(0xfffbb448), Color(0xfff7892b)])),
              child: Text(widget.buttonConfirmTitle.toString(),
